...
const ZakatMaalPage = () => {
    const pickTahun = "1446";
    const tableName = `${pickTahun}_maal`;
    ...
    return (
        <div className="flex flex-row w-screen h-screen">
            ...
            <div className="w-full p-12 text-xl text-[#2C368B]">
                <div class="flex mb-4">
                    <div class="w-full bg-[#2C368B] text-white font-extrabold h-24 rounded-2xl flex justify-center items-center text-3xl">Zakat Maal Masjid Trayu {pickTahun} H</div>
                </div>
