...
const InfaqPage = () => {
    ...
    const tableName = `${hijriYear}_infaq`;
        ...
        <div className="flex flex-row w-screen h-screen">
            ...
            <div className="w-full p-12 text-xl text-[#2C368B]">
                <div className="flex mb-4">
                    <div className="w-full bg-[#2C368B] text-white font-extrabold h-24 rounded-2xl flex justify-center items-center text-3xl">Infaq Masjid Trayu {hijriYear} H</div>
                </div>
